...
#     # Define the template for generating the blog post
#     # template = """
...
#     # """
#     template="generate code for '{input_text}' and explain me the  code generated step to step"
...
# # Route to handle POST requests and generate a response
