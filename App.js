...
// import './App.css';
// import QueriesPage from './QueriesPage'; // Import the new QueriesPage component
// import DebugPage from './DebugPage'; // Import the DebugPage component
...
//           <nav>
//             <Link to="/">Home</Link> | <Link to="/queries">Saved Queries</Link> | <Link to="/debug">Debug Code</Link> | <Link to="/optimize">Optimization</Link> |<Link  to="/review">Code Review</Link> |<Link to='/instructions'>Instructions</Link>
//           </nav>
//         </header>
...
//                   <button type="submit" className="styled-button">Generate Image Code</button>
//                 </form>
